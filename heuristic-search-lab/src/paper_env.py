...
class TP_env(Environment):
    ...
    def __init__(self):
        self.time = 0; self.stock = 20; self.stock_history = []; self.price_history = []; self.price = None
    ...
    def select_from_dist(self, distribution):
        rand_val = random.random(); cumulative = 0
    ...
    def do(self, action):
        ...
        self.stock = self.stock + bought - used; self.stock_history.append(self.stock); self.time += 1

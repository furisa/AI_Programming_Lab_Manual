...
class RobotState:
    ...
    def __eq__(self, other):
        return (self.position == other.position and self.collected == other.collected)
    ...
    def is_goal(self, problem):
        ...
        return (self.position == problem.delivery_pos and len(self.collected) == len(problem.package_positions))
